...
export default function BasicTabs() {
  ...
  const [searchvalue, setSearchValue] = React.useState<FilmOptionType | null>(null);
    ...
    <Box sx={{ width: '100%' }}>
      <Box  sx={{ borderBottom: 0, borderColor: 'divider' }}>
        <Tabs className='Tabs' value={value} onChange={handleChange} aria-label="basic tabs example">
          <MyTab label="所有题目" {...a11yProps(0)} />
          <MyTab label="简单" {...a11yProps(1)} />
          <MyTab label="中等" {...a11yProps(2)} />
          <MyTab label="困难" {...a11yProps(3)} />
        </Tabs>
      </Box>
